...
export const glossaryData: GlossaryTerm[] = [
  ...
  { id: "inert", term: "Kompleks Lembam", definition: "Kompleks yang mengalami substitusi ligan dengan sangat lambat (t₁/₂ > 1 menit)." },
  { id: "labile", term: "Kompleks Labil", definition: "Kompleks yang mengalami substitusi ligan dengan cepat (t₁/₂ < 1 menit)." },
  { id: "marcus", term: "Teori Marcus-Hush", definition: "Teori yang menjelaskan laju reaksi transfer elektron, khususnya jalur bola luar." },
